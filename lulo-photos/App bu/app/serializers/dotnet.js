...
export default DS.RESTSerializer.extend({
  ...
  extract: function (store, type, originalPayload, id, requestType){
      ...
      this._super(store, type, originalPayload, id, requestType);
  ...
  extractSingle: function(store, type, payload, id){
    ...
    return this._super(store, type, newHash, id);
  },
  ...
  normalize: function(type, hash, prop){
    ...
    return this._super(type, newHash, property);
  },
...
/*
    ...
    return this._super(originalPayload);
  },
